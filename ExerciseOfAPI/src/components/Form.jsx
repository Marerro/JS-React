...
function UserRegisterForm () {
    ...
    const formSubmitHandler = async (data) => {
        try{
            await postdata({ ...data }); // connect script post.js and spread data
        } catch (error) {
    ...
    return (
        ...
        <div className="pt-5 w-1/2 m-auto border-b border-gray-900/10 pb-12">
        ...
        <div className="w-1/2 m-auto mt-6 flex items-center justify-end gap-x-6">
